    ...
    <ul class="sidebar-nav" id="sidebar-nav">
        ...
        <li class="nav-item" {{ request()->is('primerosauxilios*') ? 'active' : '' }}>
            <a class="nav-link " data-bs-target="#components-nav" data-bs-toggle="collapse" href="#">
                <i class='bx bx-plus-medical'></i></i><span>Primeros Auxilios</span><i class="bi bi-chevron-down ms-auto"></i>
            </a>
            <ul id="components-nav" class="nav-content collapse" data-bs-parent="#sidebar-nav">
                <li class="">
                    <a class="{{$pagina == 'introduccion' ? 'active' : ''}}" href="{{url ('introduccion')}}">
